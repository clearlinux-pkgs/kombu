...
Source0  : https://files.pythonhosted.org/packages/1b/5a/c7dcbde12fc20a0842e5852a29cefb3b425ef1ecf373d19a1b7f92d264a6/kombu-4.6.9.tar.gz
...
%prep
%setup -q -n kombu-4.6.9
cd %{_builddir}/kombu-4.6.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591110371
...
cp %{_builddir}/kombu-4.6.9/LICENSE %{buildroot}/usr/share/package-licenses/kombu/d30a04a42f238f8d091587963dc3f48f862925bc
