...
Version  : 5.0.0
Release  : 58
URL      : https://files.pythonhosted.org/packages/69/cd/f2200761b43d1ecf77cc32abeedcc79d6730243dce2f65098d9159155573/kombu-5.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/69/cd/f2200761b43d1ecf77cc32abeedcc79d6730243dce2f65098d9159155573/kombu-5.0.0.tar.gz
...
%prep
%setup -q -n kombu-5.0.0
cd %{_builddir}/kombu-5.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596640143
...
cp %{_builddir}/kombu-5.0.0/LICENSE %{buildroot}/usr/share/package-licenses/kombu/d30a04a42f238f8d091587963dc3f48f862925bc
