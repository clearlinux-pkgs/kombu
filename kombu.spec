...
Source0  : https://files.pythonhosted.org/packages/14/98/00cc71801381775fbc6ad17e25d815344a44cdcdda7c0bbccbd92373bb4c/kombu-4.6.7.tar.gz
...
%prep
%setup -q -n kombu-4.6.7
cd %{_builddir}/kombu-4.6.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578426697
...
cp %{_builddir}/kombu-4.6.7/LICENSE %{buildroot}/usr/share/package-licenses/kombu/d30a04a42f238f8d091587963dc3f48f862925bc
